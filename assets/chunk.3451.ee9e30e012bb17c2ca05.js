...
return e.register("-top-level-view:main",{create:()=>s}),nt(ze).then(()=>((0,h.run)(s,"appendTo",Ve()),Pe()))}).then(()=>(Object.defineProperty(t,"element",{configurable:!0,enumerable:!0,value:!1!==L.EmberENV._APPLICATION_TEMPLATE_WRAPPER?Ve().querySelector(".ember-view"):Ve(),writable:!1}),t))}et=(0,n(7867).A)(n(2015)).renderSettled
var st=et
